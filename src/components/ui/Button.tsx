...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ 
    ...
    outline: 'border border-gray-200 text-gray-800 hover:shadow-md hover:bg-gray-50 focus:ring-gray-300',
    danger: 'border border-red-200 text-red-500 bg-white hover:bg-red-500 hover:border-red-500 hover:shadow-md hover:text-white focus:ring-red-500',
